...
public class WorkflowExecutor {
    ...
    public void restart(String workflowId, boolean useLatestDefinitions) {
        WorkflowModel workflow =
                executionDAOFacade.getWorkflowModel(workflowId, true); // TODO: need a lean workflow
        if (!workflow.getStatus().isTerminal()) {
            String errorMsg =
                    String.format(
    ...
    public void terminateWorkflow(String workflowId, String reason) {
        WorkflowModel workflow =
                executionDAOFacade.getWorkflowModel(workflowId, true); // TODO: lean workflow?
    ...
    public void updateTask(TaskResult taskResult) {
        ...
        TaskModel task =
                Optional.ofNullable(
                                executionDAOFacade.getTaskModel(
    ...
    public void pauseWorkflow(String workflowId) {
        try {
            ...
            WorkflowModel workflow =
                    executionDAOFacade.getWorkflowModel(workflowId, false); // TODO: lean workflow?
            if (workflow.getStatus().isTerminal()) {
                throw new ApplicationException(
                        CONFLICT,
    ...
    public WorkflowModel getWorkflow(String workflowId, boolean includeTasks) {
        return executionDAOFacade.getWorkflowModel(
