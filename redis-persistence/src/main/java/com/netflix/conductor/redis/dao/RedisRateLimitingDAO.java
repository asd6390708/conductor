...
public class RedisRateLimitingDAO extends BaseDynoDAO implements RateLimitingDAO {
     ...
     * TaskModel#getRateLimitPerFrequency()} and {@link TaskModel#getRateLimitFrequencyInSeconds()} if not
     * checks the {@link TaskModel} is rate limited or not based on {@link
     ...
     *       TaskModel#getRateLimitFrequencyInSeconds()} in millis), this is achieved by using {@link
     ...
     *       bounds of {@link TaskModel#getRateLimitPerFrequency()}, if so the count is increased and
